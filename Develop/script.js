...
function writePassword() 
{
  ...
  function generatePassword()
  {
    ...
    //grabs the first letter of the string entered by the user and sets it to lower_case 
    lower_case = lower_case.charAt(0)

    if((lower_case !== 'y' && lower_case !=='n'))

    
       while((lower_case !== 'y' && lower_case !=='n') )
       {
        lower_case = String(window.prompt("Do you want lowercase within your password (y/n) ?" , ""));
       }
    }
